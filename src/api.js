...
class Api extends HttpClient {
    constructor() {
        ...
        this.products = {
             ...
             */
            getProducts: (query, params = {}) => this.request(Object.assign({ path: `/products`, method: "GET", query: query }, params)),
            /**
             ...
             */
            getProduct: (productId, params = {}) => this.request(Object.assign({ path: `/products/${productId}`, method: "GET" }, params)),
            /**
             ...
             */
            getCategories: (params = {}) => this.request(Object.assign({ path: `/products/categories`, method: "GET" }, params)),
            /**
             ...
             */
            getProductsInCategory: (category, query, params = {}) => this.request(Object.assign({ path: `/products/categories/${category}`, method: "GET", query: query }, params)),
        };
        this.carts = {
            /**
             ...
             */
            getProductsInCart: (userId, params = {}) => this.request(Object.assign({ path: `/carts/user/${userId}`, method: "GET" }, params)),
            /**
             ...
             * @request POST:/carts
             */
            createCart: (body, params = {}) => this.request(Object.assign({ path: `/carts`, method: "POST", body: body, type: ContentType.Json }, params)),
            /**
             ...
             */
            updateCart: (cartId, body, params = {}) => this.request(Object.assign({ path: `/carts/${cartId}`, method: "PUT", body: body, type: ContentType.Json }, params)),
        };
    }
}
exports.Api = Api;
